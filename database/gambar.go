...
func InitCloudinary() {
	cld, err := cloudinary.NewFromParams(utils.DapatinEnvVariable("CLOUDINARY_CLOUD_NAME"), utils.DapatinEnvVariable("CLOUDINARY_API_KEY"), utils.DapatinEnvVariable("CLOUDINARY_API_SECRET"))
